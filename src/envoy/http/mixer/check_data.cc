...
const std::set<std::string> RequestHeaderExclusives = {
  ...
  CheckData::CheckData(const HeaderMap& headers, const Network::Connection* connection)
  ...
  bool CheckData::ExtractIstioAttributes(std::string* data) const override {
  ...
  bool CheckData::GetSourceIpPort(std::string* ip, int* port) const override {
    if (connection_) {
  ...
  bool CheckData::GetSourceUser(std::string* user) const override {
    return Utils::GetSourceUser(connection_, user);
  }

  std::map<std::string, std::string> CheckData::GetRequestHeaders() const override {
    return Utils::ExtractHeaders(headers_, RequestHeaderExclusives);
  }

  bool CheckData::IsMutualTLS() const override { return Utils::IsMutualTLS(connection_); }
  ...
  bool CheckData::FindCookie(const std::string& name, std::string* value) const override {
